...
<!--                    <li><a data-scroll href="#photos">Photos</a></li>-->
    ...
    <header id="site-header" class="site-header valign-center"> 
        <div class="intro">
            ...
            <h1 >Artificial&nbsp;Intelligence (AI)<br>in Advancement Summit</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut eu odio libero. Quisque non condimentum nibh. Quisque quis efficitur justo. Donec semper elit leo, sed lacinia odio tincidunt in.</p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
                        ...
                        <h3>Keynote: Artificial Intelligence 101 </h3>
						<p style="padding:12px;">Speaker: David B. Shmoys, Laibe/Acheson Professor of Business Management &nbsp; Leadership Studies, School of Operations Research and Information Engineering, Department of Computer Science</p>
                        <p>Carrier Ballroom</p>
						<p style="padding:12px;">What is AI? Where did it come from? How did we get to where we are now? Why is AI beginning to boom now? This session provides a general background for AI, giving attendees a common conceptual framework and vocabulary.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
						...
						<p style="padding:12px;">Moderator: Kim Infanti, Executive Director, Digital Engagement/Comms, Syracuse University Office of Alumni Engagement</p>
                        <p>Carrier Ballroom</p>
						<p style="padding:12px;">This panel with industry and academic experts will provide concrete, clear examples of AI as applied to industry, academia, or the consumer marketplace.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
						...
						<p style="padding:12px;">Speaker: Adam Martel, CEO and Co-founder, Gravyty</p>
                        <p>Carrier Ballroom</p>
						<p style="padding:12px;">Over lunch, we'll hear from a former major gifts fundraiser at Babson College who saw that AI could transform the scope and impact of his work.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
						...
						<p style="padding:12px;">How might AI impact the work of the various Advancement program areas? In theese facilitated workshops, we'll take the concepts and terms covered in the morning sessions and apply them to our work in fundraising, alumni relations, and communications.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
                        ...
                        <p>Carrier Ballroom</p>
						<p style="padding:12px;">Wrapping up the day, we'll share observations from the workshops and outline plans to keep the conversation going online.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="schedule-box">
